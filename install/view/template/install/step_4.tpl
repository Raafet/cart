...
<div class="container">
  ...
  <div class="mailing">
    <div class="row">
      <div class="col-sm-12"><i class="fa fa-envelope-o fa-5x"></i>
        ...
        <a href="http://opencartarab.com/lists/dada/mail.cgi/list/newsletter/" target="_BLANK" class="btn btn-secondary"><?php echo $button_mail; ?></a></div>
    </div>
  </div>
  ...
  <div class="support text-center">
    <div class="row">
      <div class="col-sm-4"><a href="https://web.facebook.com/opencartarab/" class="icon transition"><i class="fa fa-facebook fa-4x"></i></a>
        <h3><?php echo $text_facebook; ?></h3>
        <p><?php echo $text_facebook_description; ?></p>
        <a href="https://web.facebook.com/opencartarab/"><?php echo $text_facebook_visit; ?></a></div>
      <div class="col-sm-4"><a href="http://forum.opencartarab.com/index.php" class="icon transition"><i class="fa fa-comments fa-4x"></i></a>
        <h3><?php echo $text_forum; ?></h3>
        <p><?php echo $text_forum_description; ?></p>
        <a href="http://forum.opencartarab.com/index.php"><?php echo $text_forum_visit; ?></a></div>
